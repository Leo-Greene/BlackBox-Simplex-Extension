function traj = main_prsbc_bb_reverse_as_func(seed)
%MAIN_PRSBC_BB_REVERSE_AS_FUNC Run PrSBC BB reverse simulation without plotting or saving.
...
for t = 1:params.steps
    ...
    if filter_exit_flag >= 0
        ...
        % Keep original acc when filter fails.
    end
