function [a, fit_val, exit_flag, prev_sol, history, a_h] = prcbc_filter(pos, vel, params, opt)
%% prcbc_filter - 作为底层的 PrSBC 安全过滤器
% 
% 核心逻辑:
...
%   - opt          % (可选) 额外的求解器选项
    ...
    % =====================================================================
    [A_sbc, b_sbc] = compute_PrSBC_constraints(pos, vel, params_filter);
